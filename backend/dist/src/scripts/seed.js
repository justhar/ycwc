...
import { universities, scholarships, universityScholarships, } from "../db/schema.js";
...
const universitiesData = [
    {
        ...
        facilitiesInfo: {
            library: "Widener Library - One of the world's largest academic libraries",
            recreationCenter: "Malkin Athletic Center with Olympic-size pool",
            researchLabs: "State-of-the-art research facilities across all disciplines",
    ...
    },
    {
        ...
        acceptanceRate: "4.34",
        description: "Stanford University is a private research university located in Stanford, California. Known for its academic achievement, wealth, and proximity to Silicon Valley, Stanford is among the world's leading teaching and research institutions.",
    ...
    },
    {
        ...
        imageUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/f/ff/Oxford-University-Circlet.svg/1200px-Oxford-University-Circlet.svg.png",
    ...
    },
    {
        ...
        description: "The University of Tokyo, abbreviated as Todai, is a public research university located in Bunkyō, Tokyo, Japan. Established in 1877, it was the first imperial university and is considered the most prestigious university in Japan.",
        website: "https://www.u-tokyo.ac.jp/en/",
        imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/University_of_Tokyo_logo.svg/1200px-University_of_Tokyo_logo.svg.png",
        specialties: [
            "Engineering",
            "Natural Sciences",
            "Economics",
    ...
    },
    {
        ...
        imageUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/8/8a/University_of_Melbourne_Logo.svg/1200px-University_of_Melbourne_Logo.svg.png",
    ...
    },
    {
        ...
        description: "The University of Toronto is a public research university in Toronto, Ontario, Canada, located on the grounds that surround Queen's Park. It was founded by royal charter in 1827 as King's College, the oldest university in the province of Ontario.",
        website: "https://www.utoronto.ca",
        imageUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/0/04/University_of_Toronto_Logo.svg/1200px-University_of_Toronto_Logo.svg.png",
        specialties: [
            "Medicine",
            "Engineering",
            "Business",
        ...
        facilitiesInfo: {
            library: "University of Toronto Libraries - largest academic library system in Canada",
            recreationCenter: "Athletic Centre and multiple sports facilities",
            researchLabs: "Vector Institute, MaRS Discovery District, research hospitals",
...
const scholarshipsData = [
    {
        ...
        description: "A prestigious full-ride scholarship awarded to exceptional students demonstrating outstanding academic achievement, leadership potential, and community service commitment.",
        requirements: [
    ...
    },
    {
        ...
        description: "Merit-based scholarship recognizing academic excellence and potential for contribution to the university community.",
        requirements: [
    ...
    },
    {
        ...
        description: "Supporting outstanding international students in their pursuit of higher education and fostering global diversity on campus.",
        requirements: [
    ...
    },
    {
        ...
        description: "Full scholarship for students pursuing Science, Technology, Engineering, and Mathematics programs with demonstrated innovation and research potential.",
        requirements: [
    ...
    },
    {
        ...
        description: "Financial assistance program designed to help students from low-income families access quality higher education.",
        requirements: [
    ...
    },
    {
        ...
        description: "Prestigious scholarship for students from Commonwealth countries pursuing graduate studies, promoting academic collaboration and cultural exchange.",
        requirements: [
    ...
    },
    {
        ...
        description: "Government scholarship for international students to study in Japan, promoting international understanding and academic excellence.",
        requirements: [
    ...
    },
    {
        ...
        description: "Australian government scholarship program developing skills and knowledge in priority development areas, strengthening ties between Australia and partner countries.",
        requirements: [
...
async function seedDatabase() {
    try {
        ...
        const harvard = insertedUniversities.find((u) => u.name === "Harvard University");
        const presidential = insertedScholarships.find((s) => s.name === "Presidential Excellence Scholarship");
        const deans = insertedScholarships.find((s) => s.name === "Dean's Excellence Award");
        const needBased = insertedScholarships.find((s) => s.name === "Need-Based Financial Aid Grant");
        const stem = insertedScholarships.find((s) => s.name === "STEM Innovation Scholarship");
        ...
        const stanford = insertedUniversities.find((u) => u.name === "Stanford University");
        ...
        const oxford = insertedUniversities.find((u) => u.name === "University of Oxford");
        const commonwealth = insertedScholarships.find((s) => s.name === "Commonwealth Scholarship");
        const international = insertedScholarships.find((s) => s.name === "International Student Excellence Grant");
        ...
        // Tokyo relationships
        const tokyo = insertedUniversities.find((u) => u.name === "University of Tokyo");
        const mext = insertedScholarships.find((s) => s.name === "MEXT Japanese Government Scholarship");
        if (tokyo && mext)
        ...
        const melbourne = insertedUniversities.find((u) => u.name === "University of Melbourne");
        const australia = insertedScholarships.find((s) => s.name === "Australia Awards Scholarship");
        ...
        const toronto = insertedUniversities.find((u) => u.name === "University of Toronto");
        ...
        if (relationships.length > 0) {
            ...
            console.log(`✅ Created ${relationships.length} university-scholarship relationships`);
        }
