...
import { profiles, userFavorites, userScholarshipFavorites, universities, scholarships, } from "../db/schema.js";
...
app.post("/recommendations", authMiddleware, async (c) => {
    try {
        ...
        const recommendations = await aiService.generateTaskRecommendations(userProfile[0], favoriteUniversities.filter((u) => u.name), // Filter out null joins
