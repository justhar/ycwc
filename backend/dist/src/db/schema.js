import { pgTable, serial, varchar, timestamp, date, text, integer, json, pgEnum, decimal, uuid, boolean, } from "drizzle-orm/pg-core";
...
export const universities = pgTable("universities", {
    ...
    facilitiesInfo: json("facilities_info")
        .$type()
        .default({}),
    housingOptions: json("housing_options").$type().default([]),
    studentOrganizations: json("student_organizations")
        .$type()
        .default([]),
    diningOptions: json("dining_options").$type().default([]),
    transportationInfo: json("transportation_info").$type().default([]),
...
export const scholarships = pgTable("scholarships", {
    ...
    eligiblePrograms: json("eligible_programs").$type().default([]),
...
export const tasks = pgTable("tasks", {
    ...
    groupIds: json("group_ids").$type().default([]), // array of task group IDs
    notes: text("notes"),
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at")
        .defaultNow()
